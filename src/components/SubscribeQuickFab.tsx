...
export function SubscribeQuickFab() {
  ...
  return (
    <button
      ...
      className="fixed bottom-5 left-5 z-[78] max-w-[calc(100vw-2.5rem)] border border-cirta-gold/50 bg-cirta-ink/92 px-4 py-3 text-left text-[0.58rem] font-semibold uppercase leading-snug tracking-[0.14em] text-cirta-sand shadow-[0_16px_40px_-20px_rgba(0,0,0,0.9)] transition hover:border-cirta-sand/40 hover:text-cirta-gold sm:bottom-6 sm:left-6 sm:text-[0.62rem]"
    >
